    ...
    <>
      <header className="text-black-600 body-font bg-gray-900 ">
        <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
          ...
          />
          <button className="inline-flex items-center bg-gray-100 border-0 py-2 ml-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0">
            Sign In
            <svg
              fill="none"
              stroke="currentColor"
      ...
      <section className="text-gray-400 bg-gray-900 body-font">
        <div className="container px-5 py-24 mx-auto">
          ...
          <div className="flex lg:w-2/3 w-full sm:flex-row flex-col mx-auto px-8 sm:px-0 items-end sm:space-x-4 sm:space-y-0 space-y-4">
            ...
            <button className="text-white bg-green-500 border-1 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">
              {" "}
              SignUp
            </button>
          </div>
              ...
              <div className="flex relative pb-12">
                ...
                <div className="flex-grow pl-4">
                  ...
                  <p className="leading-relaxed">
                    ...
                    everything’s green. Reviews approved? Check. Tests passing?
